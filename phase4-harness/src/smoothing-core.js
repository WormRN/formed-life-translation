...
export function buildSourceAwarePrompt(candidate,source,listenerReports){
  ...
  material.output_contract='Return at most six changed verses and three remaining risks. Keep every explanatory field, constitutional rationale, risk, and recommendation to one sentence of no more than 30 words. Do not repeat the source brief.';
