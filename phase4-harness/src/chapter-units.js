...
import {assertPassageSenseResolution,assertLockedMatrixAlerts,assertPacketMatrixHygiene,unitSenseMaterial,assertCandidateSenseApparatus,assertCommonBasePromptHash,parseModelJson} from './sense-resolution-core.js';
...
assertLockedMatrixAlerts(chapter,{matrixMarkdown:`${matrixMarkdown}\n\n${authorityTypesMarkdown}`,sourceLemmaIndex});
...
for(const unit of chapter.units){
  ...
  assertPacketMatrixHygiene(common);
