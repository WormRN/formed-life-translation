...
const expected=Array.from({length:7},(_,i)=>`Phil.1.${i+12}`);
...
const reconstructionPrompt=`${readerProfile} Reconstruct the meaning of each verse and the passage as a whole. Do not evaluate translation quality and do not guess missing source wording. Schema: {"verse_meanings":[{"reference":"Phil.1.12","propositions":["..."],"inferred_relationships":["..."]}],"passage_summary":"...","unclear_phrases":[{"reference":"...","phrase":"...","possible_meanings":["..."]}]}. Exactly seven verses in order. ENGLISH ONLY:${JSON.stringify(candidate.verse_renderings)}`;
