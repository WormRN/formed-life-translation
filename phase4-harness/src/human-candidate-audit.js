...
const exampleRef=expected[0]||'BOOK.CHAPTER.VERSE';
...
const reconstructionPrompt=`${readerProfile} Reconstruct the meaning of each verse and the passage as a whole. Do not evaluate translation quality and do not guess missing source wording. Schema: {"verse_meanings":[{"reference":"${exampleRef}","propositions":["..."],"inferred_relationships":["..."]}],"passage_summary":"...","unclear_phrases":[{"reference":"...","phrase":"...","possible_meanings":["..."]}]}. Include exactly every supplied verse in order. Be concise enough to complete the JSON. ENGLISH ONLY:${JSON.stringify(candidate.verse_renderings)}`;
