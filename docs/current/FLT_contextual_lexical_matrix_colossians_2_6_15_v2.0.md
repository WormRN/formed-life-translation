# FLT Contextual Lexical Matrix — Colossians 2:6–15 Unit Overlay v2.0

**Authority:** Human Editor-approved unit overlay.  
**Engine:** 2.2  
...
- **φιλοσοφία (2:8):** context-specific deceptive teaching; not a blanket condemnation of philosophy.
- **συλαγωγέω (2:8):** captivity/spoil metaphor; retain where natural.
- **στοιχεῖα (2:8; forward 2:20):** approved underdetermined guidance `the elemental principles that govern this world`. Elementary-principles/rudiments and cosmic/elemental-powers readings remain live. `spirit powers` and `basic teachings` are forbidden premature resolutions. `[tn]` required.
- **πλήρωμα / πληρόω family (2:9–10):** preserve the rhetorical handoff where clear. `πεπληρωμένοι` is perfect passive and must describe an already-established state, never aspiration/progression. No corpus-level πληρ- English policy exists yet.
- **θεότης (2:9):** full deity / what belongs to being God; do not weaken the claim.
...
- **συνθάπτω / συνεγείρω / συζωοποιέω (2:12–13):** buried with / raised with / made alive with Christ. The with-Christ element is mandatory in all three.
- **πίστις + τῆς ἐνεργείας τοῦ θεοῦ (2:12):** contested. Working ruling: faith in God's working; alternative: faith produced by/from God's working. `[tn]` required; neither is settled.
- **χαρίζομαι (2:13):** forgive primary, grace-gift coloring available where natural.
- **subject continuity (2:13–15):** God is the working subject construal, not a certainty. One subject must be maintained consistently; mid-sentence God/Christ drift is blocking.
- **χειρόγραφον (2:14):** written record of indebtedness/obligation against us; do not equate directly with Mosaic law.
